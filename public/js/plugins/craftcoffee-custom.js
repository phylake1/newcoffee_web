jQuery(document).ready(function(){ 
	...
	/* DISABLED: paddingTop calculation - handled by CSS */
	
	if(false) /* DISABLED: nofixed scroll - handled by CSS */
	{	
		jQuery(window).scroll(function(){
	...
	/* DISABLED: elementor header scroll visibility - handled by CSS */
